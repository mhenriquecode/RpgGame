...
public class RpgCharacterRepositoryTest {
    ...
    @Nested
    @DisplayName("TDD Characters repository test")
    class TddCharactersRepositoryTest {
        @Test
        @Tag("Unit-test")
        @Tag("TDD")
    ...
    @Nested
    @DisplayName("Unit Characters repository test")
    class UnitCharactersRepositoryTest {
        @Test
        @Tag("Unit-test")
